...
1. In the **Activities** table, click the **Details** action to open the workout modal (Overview, Activity, Route map, Profile elevation/pace chart, Intervals, and Comparisons).
